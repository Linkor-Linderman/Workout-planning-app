...
@Composable
fun ComplexListPage(
    listOfComplex: List<ComplexInfo>,
    onComplexInfoClick: (ComplexInfo) -> Unit,
) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        if (listOfComplex.isEmpty()) {
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "You do not have complexes in your list",
            ...
            LazyColumn(
                ...
                item {
                    listOfComplex.forEach { complexInfo ->
                        ComplexInfoItem(
                            complexInfo
                        ) {
                            onComplexInfoClick(it)
                        }
                        Spacer(modifier = Modifier.height(8.dp))
                    }
                }
